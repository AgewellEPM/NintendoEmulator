...
#ifndef EMULATORKIT_SWIFT_H
#define EMULATORKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EmulatorKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11EmulatorKit14AuthAPIService")
@interface AuthAPIService : NSObject <NSURLSessionDelegate>
...
SWIFT_CLASS("_TtC11EmulatorKit12OAuthManager")
...
@interface OAuthManager (SWIFT_EXTENSION(EmulatorKit)) <ASAuthorizationControllerPresentationContextProviding>
