...
@objcMembers
public final class WiiCore: NSObject, EmulatorCoreProtocol {
    public let coreIdentifier = "com.emulator.wii"
    public let coreVersion = "0.1.0"
    public let supportedSystems: [EmulatorSystem] = [.wii]
    ...
    public func validateROM(data: Data) -> ROMValidationResult { ROMValidationResult(isValid: true, system: .wii) }
